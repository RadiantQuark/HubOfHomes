...
<body>
  <?php if(!isset($_GET['id'])) {echo 'Page cannot be accessed'; header("Location: listing.php");}?>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item d-none d-sm-inline-block d-lg-none">
            <button class="btn btn-small btn-outline" href="/includes/logout.php" >Log Out</button>
          </li>
        </ul>
...
<!-- ---------------------------------SQL QUERY-------------------------------------------- -->
<?php $id = $_GET['id']; $data = mysqli_fetch_assoc($mysqli->query("SELECT * FROM properties WHERE property_id=$id"));?>
      ...
      <div class="col-lg-8">
        <div class="property-details-banner property-details-banner-for">
          <div class="property-details-banner-featured">
            <a href="images/<?php echo $data['property_id'] . '.png';?>" class="property-details-banner-link"> 
              <img src="images/<?php echo $data['property_id'] . '.png';?>" alt="properties-banner">
            </a>
          </div>
          <div class="property-details-banner-featured">
            <a href="images/<?php echo $data['property_id'] . '_2.png';?>" class="property-details-banner-link"> 
              <img src="images/<?php echo $data['property_id'] . '_2.png';?>" alt="properties-banner">
            </a>
          </div>
          <div class="property-details-banner-featured">
            <a href="images/<?php echo $data['property_id'] . '_3.png';?>" class="property-details-banner-link"> 
              <img src="images/<?php echo $data['property_id'] . '_3.png';?>" alt="properties-banner">
            </a>
          </div>
          <div class="property-details-banner-featured">
            <a href="images/<?php echo $data['property_id'] . '_1.png';?>" class="property-details-banner-link"> 
              <img src="images/<?php echo $data['property_id'] . '_1.png';?>" alt="properties-banner">
            </a>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="property-details-banner-container">
          <div class="property-details-banner property-details-banner-nav">
            <div class="property-details-banner-featured">
              <img src="images/<?php echo $data['property_id'] . '.png';?>" alt="properties-banner">
            </div>
            <div class="property-details-banner-featured">
          ...
          <div class="totalslide d-flex align-items-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M19.5 3.75H4.5C4.08579 3.75 3.75 4.08579 3.75 4.5V19.5C3.75 19.9142 4.08579 20.25 4.5 20.25H19.5C19.9142 20.25 20.25 19.9142 20.25 19.5V4.5C20.25 4.08579 19.9142 3.75 19.5 3.75Z" stroke="#1C4456" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M20.25 14.9999L16.2844 11.0343C16.2146 10.9634 16.1314 10.9072 16.0397 10.8687C15.9479 10.8303 15.8495 10.8105 15.75 10.8105C15.6505 10.8105 15.5521 10.8303 15.4603 10.8687C15.3686 10.9072 15.2854 10.9634 15.2156 11.0343L11.0344 15.2155C10.9646 15.2864 10.8814 15.3427 10.7897 15.3811C10.6979 15.4195 10.5995 15.4393 10.5 15.4393C10.4005 15.4393 10.3021 15.4195 10.2103 15.3811C10.1186 15.3427 10.0354 15.2864 9.96563 15.2155L8.03437 13.2843C7.96459 13.2134 7.8814 13.1572 7.78966 13.1187C7.69792 13.0803 7.59946 13.0605 7.5 13.0605C7.40054 13.0605 7.30208 13.0803 7.21034 13.1187C7.1186 13.1572 7.03541 13.2134 6.96563 13.2843L3.75 16.4999" stroke="#1C4456" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M9.375 9.75C9.99632 9.75 10.5 9.24632 10.5 8.625C10.5 8.00368 9.99632 7.5 9.375 7.5C8.75368 7.5 8.25 8.00368 8.25 8.625C8.25 9.24632 8.75368 9.75 9.375 9.75Z" fill="#1C4456"></path>
            </svg>              
    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="property-details-content">
          <div class="property-details-content-title">
            <h4><?php echo $data['property_name'];?></h4>
             <p class="bold"><?php echo $data['address'];?></p>
          </div>
          <div class="property-details-content-radio-button">
            <div class="property-details-content-radio-button-item">
              <input type="radio" class="btn-check" name="options" id="option1">
              <label class="property-price-payment" for="option1">
                <span class="price">₹<?php echo $data['price'];?></span>
                <span class="time-period">Online / Cash Payment</span>
              </label>
            </div>
            <div class="property-details-content-radio-button-item">
              <input type="radio" class="btn-check" name="options" id="option2">
              <label class="property-price-payment" for="option2">
                <span class="price">₹<?php echo $data['rent'];?> / month</span>
                <span class="time-period">0% EMI for 6 Months</span>
              </label>
            </div>
          </div>
          <div class="property-details-content-details">
            <p class="bold"><?php echo $data['short_desc'];?></p>
            <p><?php echo $data['description'];?></p>
          </div>

          <div class="property-details-content-local-info">
            ...
            <ul class="nav nav-tabs property-details-content-local-info-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="school-tab" data-bs-toggle="tab" data-bs-target="#school" type="button" role="tab" aria-controls="school" aria-selected="false">Schools</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="crime-tab" data-bs-toggle="tab" data-bs-target="#crime" type="button" role="tab" aria-controls="crime" aria-selected="false">Cinema</button>
              </li>
              <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane active" id="map" role="tabpanel" aria-labelledby="map-tab">
                <div class="listing-map">
                  <img src="images/map2.png" alt="listing" class="listing-map--image">
                  <!--Listing map Pins -->
                  <div class="listing-map--shape1 listing-map--pin">
                    <img src="images/pin.png" alt="listing">
                    <div class="listing-map--pin-content">
                  ...
                  <!--Listing map Pins -->
                  <div class="listing-map--shape2 listing-map--pin">
                    <img src="images/pin.png" alt="listing">
                    <div class="listing-map--pin-content">
                      <div class="d-flex align-items-center properties-card--content--address">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="tab-pane fade" id="school" role="tabpanel" aria-labelledby="school-tab">
                <div class="listing-map">
                  ...
                  <!--Listing map Pins -->
                  <div class="listing-map--shape4 listing-map--pin">
                    <img src="images/pin.png" alt="listing">
                    <div class="listing-map--pin-content">
                      <div class="d-flex align-items-center properties-card--content--address">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="tab-pane fade" id="crime" role="tabpanel" aria-labelledby="crime-tab">
                <div class="listing-map">
                  ...
                  <!--Listing map Pins -->
                  <div class="listing-map--shape3 listing-map--pin">
                    <img src="images/pin.png" alt="listing">
                    <div class="listing-map--pin-content">
                      <div class="d-flex align-items-center properties-card--content--address">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <!--Listing map Pins -->
                  <div class="listing-map--shape5 listing-map--pin">
                    <img src="images/pin.png" alt="listing">
                    <div class="listing-map--pin-content">
                      <div class="d-flex align-items-center properties-card--content--address">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="property-details-agent">
          ...
          <div class="property-details-agent-content d-flex align-items-center">
            ...
            <div class="property-details-agent-content-name">
             <a href="agent-details.php"> <h5>Bruno Fernandes</h5></a>
      ...
      <div class="col-lg-4">
        <div class="property-details-form d-none d-lg-block">
          ...
          <form class="contact-form-items" method="POST" action="includes/insertRequest.php">
            ...
            <div class="input-group">
              <textarea class="form-control" placeholder="Message" rows="15" cols="20" id="message" name="message"></textarea>
            </div>
            <div class="w-100 contact-form-button">
              <button type="submit" class="btn btn-large d-block w-100">Send Request</button>
            </div>
